        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                ...
                <ul class="nav nav-pills" id="myTab" role="tablist">
                    ...
                    ?>
                    <li class="nav-item">
                        <a class="nav-link rounded-pill <?php if(!$i) echo 'active' ?>" id="<?= $post -> post_name ?>-tab" data-toggle="tab" href="#<?= $post -> post_name ?>" role="tab" aria-controls="webdesign" aria-selected="true">
                           <?php the_title(); ?>
                        </a>
                    </li>
                   <?php $i++; endforeach; ?>
                ...
                <div class="tab-content" id="myTabContent">
                    <?php foreach($data as $k => $item) : ?>
                        <div class="tab-pane fade show <?php if(!$k) echo 'active'?>" id="<?= $item['post_name'] ?>" role="tabpanel" aria-labelledby="<?= $item['post_name'] ?>-tab">
                            <?= $item['content'] ?>
                            <p><a href="<?= $item['url'] ?>" class="btn btn-pink btn-shadow">
                                <?= __('Read more', 'bluerex') ?></a>
                            </p>
                        </div>
                    <?php endforeach; ?>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p><a href="<?= get_category_link (5); ?>" class="btn btn-pink btn-shadow">
                        <?= __('Read more', 'bluerex') ?>
                </a></p>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <?php foreach ($posts as $post) : setup_postdata($post);?>
                        <div class="col-md-6 mb-3">
                            ...
                            <h2><?php the_title() ?></h2>
                            <?php the_content('') ?>
                            <p><a href="<?php the_permalink ?>" class="btn btn-pink btn-shadow">
                                    <?= __('Read more', 'bluerex') ?>
                            </a></p>
                        </div>
                    <!-- /.col-md-6 -->
...
<section class="section-work section-tabs">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="nav nav-pills" id="myTab-gallery" role="tablist">
                    <?php
                    $data = [];
                    $i = 0;
                    foreach($posts as $post):
